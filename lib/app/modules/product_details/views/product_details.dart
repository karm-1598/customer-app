import 'package:cached_network_image/cached_network_image.dart';
  ...
  import 'package:shopperz/app/modules/category/model/category_wise_product.dart' as category_product;
  import 'package:shopperz/app/modules/home/model/popular_product.dart' as Product;
  import 'package:shopperz/app/modules/home/model/product_section.dart' as section_product;
                    ...
                    child: RefreshIndicator(
                        ...
                        child: SingleChildScrollView(
                            ...
                            child:
                              ...
                              CachedNetworkImage(
                                  imageUrl: isClicked
                                      ? productDetailsController.productModel.value.data?.images![isSelected] ?? ""
                                      : productDetailsController.productModel.value.data?.image ?? "",
                              ...
                              productDetailsController.productModel.value.data!.images!.isEmpty
                                  ? const SizedBox()
                                  : SizedBox(
                                      height: 80.h,
                                          ...
                                          itemBuilder: (context, index) {
                                            return GestureDetector(
                                                ...
                                                child: CachedNetworkImage(
                                                    imageUrl: productDetailsController.productModel.value.data!.images![index],
                                                    imageBuilder: (context, imageProvider) => Container(
                                                        ...
                                                        decoration: BoxDecoration(
                                                            ...
                                                            border:
                                                                Border.all(color: isSelected == index ? Colors.black : Colors.transparent, width: 2),
                              ...
                              Column(mainAxisAlignment: MainAxisAlignment.spaceEvenly, crossAxisAlignment: CrossAxisAlignment.start, children: [
                                CustomText(
                                    ...
                                    text: productDetailsController.productModel.value.data!.name,
                                    size: 22.sp,
                                    ...
                                    if (productDetailsController.initialVariationModel.value.data != null) {
                                      return CustomText(
                                          text: productDetailsController.variationProductCurrencyPrice.toString() == ''
                                              ? productDetailsController.productModel.value.data?.currencyPrice.toString() ?? ''
                                              : productDetailsController.variationProductCurrencyPrice.toString(),
                                          size: 18.sp,
                                          weight: FontWeight.w700);
                                    }
                              ...
                              Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                                SecondaryButton(
                                    ...
                                    onTap: () async {
                                      debugPrint("🚀 DEBUG: Add to Cart Button Pressed",wrapWidth: 1024);
