...
class AuthController extends GetxController {
  ...
  signInWithEmail({required String email, required String password,required String deviceType,String? deviceID}) async {
    isLoading(true);
    try {
      ...
      print(deviceID);
      final response = await AppServer().httpPost(
        endPoint: "${ApiList.login}emailId="+ email + "&password=" + password + "&DeviceID=" + deviceID + "&DeviceType=" + deviceType + "",
        body: {
          "email": email,
          "password": password,
        },
  ...
  // signInWithEmail({required String email, required String password,required String deviceID,required String deviceType }) async {
  //   isLoading(true);
  //   try {
  //     final response = await AppServer().httpPost(
  //       endPoint: "${ApiList.login}emailId="+ email + "&password=" + password + "&DeviceID=" + deviceID + "&DeviceType=" + deviceType + "",
  ...
  //       customSnackbar(
  //           "SUCCESS".tr,
  //           responseBody["message"].toString().tr,
  //           AppColor.success);
  //       Future.delayed(const Duration(milliseconds: 10), () {
  //         update();
  //       });
  ...
  //       customSnackbar(
  //           "ERROR".tr,
  //           responseBody["errors"]['validation'].toString().tr,
  //           AppColor.error);
  //     }
  //   } catch (e) {
  //     isLoading(false);
